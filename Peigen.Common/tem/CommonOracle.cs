    ...
    public class Common : CodeTemplate
	{
        ...
        public string GetCSharpSqlType(ColumnSchema column)
        {
            ...
            switch (column.DataType)
            {
                ...
                case DbType.Object: return ".Clob";
		...
		/// <param name="column"></param>
		/// <returns></returns>
		public string GetOraDbType(ColumnSchema column)
		{
			switch (column.NativeType)
			{
				...
				case "NUMBER":
				{   
				 if ((column.Precision <=10)&&(column.Scale == 0))
				 {   
				   return "Int32";   
				 }   
				 else  
		...
		public string GetReaderMethod(ColumnSchema column)
		{
            ...
            switch (column.NativeType)
			{
				...
				case "smallmoney": return "GetFloat";
				case "sql_variant": return "GetString";
				case "sysname": return "GetChar";
				case "text": return "GetString";		
				case "tinyint": return "GetShort";
				case "uniqueidentifier": return "GetString";
				case "varbinary": return "GetByte";
		...
		public List<ColumnSchema> GetInsertColumn(TableSchema table)
		{
			...
			{
				if (!(((column.IsPrimaryKeyMember)&&(!column.IsForeignKeyMember)&&(column.DataType == DbType.Int32))))
				{
					list.Add(column);
				}
			}
		...
		/// <param name="column"></param>
		/// <returns></returns>
		public string GetFiledSize(ColumnSchema column)
		{
			string tmp = "";
			switch (column.NativeType)
			{
				case "NUMBER":
					tmp = "," + column.Precision.ToString();
					break;
				case "BFILE":
				case "BLOB":
				case "CHAR":
		...
		public string GetMemberVariableName(ColumnSchema column)
		{
			...
			string memberVariableName = GetLowerCaseName(propertyName);
		...
		/// <param name="value"></param>
		/// <returns></returns>
		public string GetUpperCaseName(string value)
		{
